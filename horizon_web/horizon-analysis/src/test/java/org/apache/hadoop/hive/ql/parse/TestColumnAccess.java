...
public class TestColumnAccess {
  ...
  public static void Teardown() throws Exception {
    ...
    driver.run("drop table t4");
  }

  @Test
  public void testQueryTable1() throws ParseException {
    String query = "create table t4 as select * from t1";
    Driver driver = createDriver();
    ...
    TableAccessInfo tableAccessInfo = plan.getTableAccessInfo();
    Map tableOpList = tableAccessInfo.getOperatorToTableAccessMap();

    System.out.println("tablesize  ========== " + tableAccessInfo.getOperatorToTableAccessMap().size());
