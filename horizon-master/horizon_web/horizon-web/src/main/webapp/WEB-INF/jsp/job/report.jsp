          ...
          <div class="box">
            ...
            <div class="box-body table-responsive" style="overflow-x: hidden">
              <table id="dbList" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:forEach items="${ reportJobList }" var="jobInfo">
                <tr>
                  <td class="row_detail_edit" data-target="#row_detail_db_id">${ jobInfo.id }</td>
                  <td class="row_detail row_detail_edit" data-target="#row_detail_db_name">${ jobInfo.name }</td>
                  <td class="row_detail_edit" data-target="#row_detail_database_name">${ jobInfo.report_name }</td>
                  <td class="row_detail_edit" data-target="#row_detail_dialect">${ jobInfo.location_path }</td>
                  <td class="row_detail_edit" data-target="#row_detail_db_desc">${ jobInfo.send_type }</td>
                  <td class="row_detail_edit" data-target="#row_detail_db_desc">${ jobInfo.manager }</td>
                  <td name="is_enable" class="row_detail_edit">
                    <c:choose>
                      <c:when test="${jobInfo.status eq 0}">
                  ...
                  <td name="update_time">
                    <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${ jobInfo.update_time }"
                                    type="both"/>
                  </td>
                  <td>
                    <div class="btn-group">
                      ...
                      <c:choose>
                        ...
                        <button name="btn_db_status_control" type="button" class="btn btn-default"
                            href="<%= path %>/resource/db/${jobInfo.id}/status_control"
                  ...
                  <td class="row_detail" style="display:none" data-target="#row_detail_create_time">
                    <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${ jobInfo.create_time }" type="both"/>
                  </td>
